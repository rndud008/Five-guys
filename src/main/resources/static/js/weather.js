        ...
        $.ajax({
            ...
            success: function () {
                ...
                $.ajax({
                                ...
                                $.ajax({
                                    ...
                                    success: function () {
                                        ...
                                        $.ajax({
                                            ...
                                            success: function () {
                                                // AJAX 요청6: 업데이트된 중기예보 정보(기온) 가져오기
                                                $.ajax({
                                                    url: "/weather/getWeather3",
                                                    type: "GET",
                                                    data: {
                                                        areacode: areacode
                                                    },
                    ...
                    error: function () {
                        // 에러 처리 - 업데이트된 단기예보 정보 가져오기 실패
                        console.log("업데이트된 단기예보 정보를 가져오는 데 실패했습니다.");
                    }
                });
            },
            error: function () {
                // 에러 처리 - 단기예보 정보 업데이트 실패
                console.log("단기예보 정보를 업데이트하는 데 실패했습니다.");
            }
        });
    });
