...
(
  ...
  last_call_api_id INT         NOT NULL COMMENT 'API 호출 id',
  areacode         INT         NOT NULL COMMENT '지역코드번호',
  tmFc             VARCHAR(10) NULL     COMMENT '예보일자',
...
(
  ...
  tmn         VARCHAR(3)  NULL     COMMENT '최저기온',
  tmx         VARCHAR(3)  NULL     COMMENT '최고기온',
  sky         VARCHAR(3)  NULL     COMMENT '하늘상태',
  pop         VARCHAR(3)  NULL     COMMENT '강수량',
  pty         VARCHAR(3)  NULL     COMMENT '강수형태',
  fcstValue   VARCHAR(2)  NULL     COMMENT '카테고리값',
  PRIMARY KEY (id)
) COMMENT '단기예보(1~3일)';
